% source: https://tex.stackexchange.com/a/498765 [adjusted]
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[%
        ...
        \node[raylabel, fill=white, align=center] at (CONNECTION_6) {RF\\radiation};
    ...
    \caption{Diagram of the EM spectrum as a function of the wavelength. \emph{Ionizing} radiation occurs when a photon’s energy is greater than \SI{10}{\eV}, i.e., under the lower end of ultraviolet (UV) spectrum. Visible, infrared (IR), RF and low-frequency (LF) radiation is thus \emph{non-ionizing}.}
